...
function t(a, b, c) {
    ...
    for (m = 0; m < n; m++)
        ...
        g = l;
    for (m = 0; 4 > m; m++)
        r[c ? 3 & -m : m] = x[e >>> 24] << 24 ^ x[f >> 16 & 255] << 16 ^ x[g >> 8 & 255] << 8 ^ x[b & 255] ^ d[p++],
        h = e,
        e = f,
        f = g,
        g = b,
...
sjcl.bitArray = {
    ...
    byteswapM: function(a) {
        ...
        for (b = 0; b < a.length; ++b)
            c = a[b],
            a[b] = c >>> 24 | c >>> 8 & 0xff00 | (c & 0xff00) << 8 | c << 24;
        return a
    }
};
...
sjcl.hash.sha256 = function(a) {
    this.b[0] || this.O();
    a ? (this.F = a.F.slice(0),
    this.A = a.A.slice(0),
    this.l = a.l) : this.reset()
}
;
...
sjcl.mode.gcm = {
    ...
    C: function(a, b, c, d, e, f) {
        ...
        g = b.encrypt([0, 0, 0, 0]);
        96 === h ? (e = e.slice(0),
        e = q.concat(e, [1])) : (e = sjcl.mode.gcm.j(g, [0, 0, 0, 0], e),
...
sjcl.prng.prototype = {
    randomWords: function(a, b) {
        ...
        if (d & this.J) {
            ...
            for (d = 0; 4 > d && (this.h[d] = this.h[d] + 1 | 0,
            !this.h[d]); d++)
                ;
        }
        for (d = 0; d < a; d += 4)
...
function z(a) {
    for (var b = 0; 4 > b && (a.h[b] = a.h[b] + 1 | 0,
    !a.h[b]); b++)
        ;
...
sjcl.json = {
    ...
    ia: function(a, b, c, d) {
        ...
        "string" === typeof a ? (g = sjcl.misc.cachedPbkdf2(a, b),
